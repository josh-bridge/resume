...
\newcommand{\NewLinkEntry}[2]{\noindent\hangindent=0.5em\hangafter=0 \parbox{\datebox}{\small \textit{#1}} #2 \vspace{0.5em}}% Define a command for each new block - change spacing and font sizes here: #1 is the left margin, #2 is the italic date field and #3 is the position/employer/location field
...
\newcommand{\Descriptionlol}[1]{\hangindent=0em\hangafter=0\noindent\raggedright\footnotesize{#1}\par\normalsize} % Define a command for descriptions of each entry - change spacing and font sizes here
...
\Descriptionlol{\MarginText{About me}I'm a server developer with a deep interest and understanding of computing and its surrounding fields. \\I thoroughly enjoy solving problems and when taking on a piece of work I constantly strive to create the highest quality product, honing my own skills in the process.}
