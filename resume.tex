...
\newcommand{\NewLinkEntry}[2]{\parbox{\lolbox}{\small \textit{#1}} #2 \vspace{0.5em}}% Define a command for each new block - change spacing and font sizes here: #1 is the left margin, #2 is the italic date field and #3 is the position/employer/location field
